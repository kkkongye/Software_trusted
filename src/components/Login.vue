...
.login-container {
  ...
  align-items: center;
  min-height: 100vh;
  background: linear-gradient(135deg, #2c3e50, #4a90e2, #2c3e50);
  background: linear-gradient(135deg, #333333, #666666, #444444);
...
.login-btn {
  ...
  width: 100%;
  padding: 14px 20px;
  background: linear-gradient(to right, #4a90e2, #2980b9);
...
.login-btn:hover {
  background: linear-gradient(to right, #3a7bca, #2471a3);
...
.login-btn:disabled {
  background: linear-gradient(to right, #97bff0, #7fb3d5);
